...
#wont be of much use as employer directly do not make a person defaulter  -------- Disagree we will discuss.
...
#Pritam--- More the no of inquiry more Credit Hungry which reduces the Credit rating of the Borrower.
#Ramesh--- Need Discussion
...
#Pritam----- also we have to keep in mind that the higher value means user has not delenquent in that much days.
#Ramesh ----- Need discussion
