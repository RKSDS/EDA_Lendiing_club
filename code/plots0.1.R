...
ggplot(loan_ds_clean, aes(int_rate, col="red")) + geom_histogram(binwidth = 1) + 
  scale_x_discrete(name="Interest Rates", limits=seq(5,26,1))
...
ggplot(loan_ds_clean, aes(int_rate, col="black",fill=as.factor(term))) + geom_histogram(binwidth = 1, position = "fill") +
  scale_x_discrete(name="Interest Rates", limits=seq(5,26,1)) +
  labs(y="Percent of loans", title="Interest Rate for Different terms of Loan", fill="Terms")
